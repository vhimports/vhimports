...
const demoProducts = [
  { id: 'air-force-1', brand: 'Nike', category: 'Lifestyle', name: 'Air Force 1 Essential', line: 'Air Force', price: 699.9, oldPrice: 799.9, badge: 'MAIS VENDIDO', imageUrl: catalogNike01, altImage: catalogNike02 },
...
const familyTiles = [
  { label: 'VH no corre', image: catalogNike01 },
  { label: 'VH na rua', image: catalogNike02 },
  { label: 'VH no detalhe', image: catalogNike03 },
  { label: 'VH no movimento', image: catalogNike04 },
...
export default function Storefront() {
  ...
  return (
    <div className="vh-site">
      ...
      <main>
        <section className="vh-hero" id="inicio"><div className="hero-editorial"><span className="vh-kicker">VH IMPORTS <i /> DESDE 2020</span><h1>Seu próximo passo <em>começa aqui.</em></h1><p>Uma curadoria de tênis importados para quem transforma o cotidiano em estilo.</p><div className="hero-actions"><a className="vh-button" href="#desejados">Explorar coleção <ArrowIcon /></a><a className="hero-text-link" href="#marcas">Ver por marca <ArrowIcon /></a></div><div className="hero-meta"><span>01</span><span className="meta-line" /><span>ESTILO · MOVIMENTO · IDENTIDADE</span></div></div><div className="hero-visual"><div className="hero-photo hero-photo-main" style={{ backgroundImage: `url("${catalogNike03}")` }} /><div className="hero-photo hero-photo-detail" style={{ backgroundImage: `url("${catalogNike04}")` }} /><div className="hero-sticker">VH<br /><small>IMPORTS</small></div><div className="hero-product-note"><span>NO CATÁLOGO VH</span><strong>Air Force em destaque.</strong><a href="#desejados">Ver modelos <ArrowIcon /></a></div></div><div className="hero-scroll">SCROLL PARA DESCOBRIR <span /></div></section>
